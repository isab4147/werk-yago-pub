...
\frame{
	...
	\begin{block}{}
		...
		\end{itemize}
	\end{block}
	\centerline{\includegraphics[width=0.75\linewidth]{Figuras/Ch05/fig1.jpg}}
}
...
\frame{
	...
	\end{block}
	\centerline{\includegraphics[height=0.45\textheight]{Figuras/Ch05/fig2.jpg}}
}
...
\frame{
	...
	\end{block}
	\centerline{\includegraphics[width=0.6\linewidth]{Figuras/Ch05/fig3.jpg}}
}
...
\frame{
	...
	\end{block}
	\centerline{\includegraphics[width=0.6\linewidth]{Figuras/Ch05/fig4.jpg}}
}
