...
\usetikzlibrary{positioning, calc,
	patterns, arrows.meta, decorations.pathmorphing,
	circuits.plc.ladder}

% Representação de diagramas ladder
\newlength{\ladderskip}
...
% setup do siunitx
\sisetup{per-mode=symbol,output-decimal-marker={,},binary-units,detect-weight=true, detect-family=true}
...
\title[Princípios de Controle e Automação]
{Princípios de Controle e Automação}
...
Curso Técnico Subsequente em Automação \\
